...
const CommentsSection = async ({ postId }: CommentsSectionProps) => {
	...
	return (
		<div className='flex flex-col gap-y-4 mt-4'>
			<hr className='w-full h-px my-6 border-[0.1px] border-black' />
					...
					.map((topLevelComment) => {
						...
						return (
							<div
								...
								className='flex flex-col border-b border-black pb-6 last:border-none'>
								<div className='mb-2'>
									<PostComment
								...
								{topLevelComment.replies
									...
									.map((reply) => {
										...
										return (
											<div
												key={reply.id}
												className='ml-2 py-2 pl-4 border-l'>
												<PostComment
													comment={reply}
